...
\textit{perceptron algorithm}, il quale però presenta alcuni problemi di convergenza. Essendo
il perceptron un separatore lineare ho pensato di implementare un algoritmo basato
su tecniche di \textit{linear programming}. La programmazione lineare si occupa infatti
...
problemi e ho constatato che risulta significativamente più veloce del \texit{perceptron
algorithm}.
